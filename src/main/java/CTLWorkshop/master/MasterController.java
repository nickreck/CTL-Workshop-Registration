...
public class MasterController {
    ...
    public String viewSubmittedRegistrationPage(@ModelAttribute("attendee") Attendee attendee) {
        ...
        attendee.send("testingjavaemail36@gmail.com","Pineapplessuck010!", attendee.getId(),"CTL Workshop Registration", "Thank you, " + attendee.getFirstname() + " for registering for " + attendee.getWorkshopnum() + "You will receive a reminder 24 hrs before the workshop that will include the address/online link.");
